...
import com.iosflashscreen.phonecallerid.screencaller.ui.Theme_GifActivity_Calling_Theme_Preview;
import com.iosflashscreen.phonecallerid.screencaller.utils.GifDrawableUtil;
...
public class ViewPager1Adapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        GifImageView imageView = view.findViewById(R.id.gifimage_view);
        TextView phone_no = view.findViewById(R.id.phone_no);
        TextView Username = view.findViewById(R.id.Username);
        RelativeLayout full=view.findViewById(R.id.full1);
